...
export async function getInteractiveSetup() {
  ...
  console.log(chalk.cyan('║  Backendify - Interactive Setup        ║'));
  console.log(chalk.cyan('╚════════════════════════════════════════╝\n'));
...
# MONGODB_URI=mongodb+srv://<username>:<password>@cluster.mongodb.net/backendify?retryWrites=true&w=majority
